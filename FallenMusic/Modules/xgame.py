...
GAME_MESSAGE = "⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞. ━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب افـاتار\n\n⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('★¦العاب افـاتار', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.', url =f"https://t.me/sourceav")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.━⊶★━⩺\n\nمرحبا بك في قسم العاب افـاتار 3D\n\n⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب افـاتار\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━.〝𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝〞.━⊶★━⩺" 
